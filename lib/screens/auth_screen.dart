  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: AnimatedContainer(
        height: _authMode == AuthMode.signup ? 330 : 266,
        //height: _heightAnimation.value.height,
        constraints: BoxConstraints(minHeight: _authMode == AuthMode.signup ? 330 : 266),
            ...
            child: Column(
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  obscureText: true,
                  textInputAction:
                      _authMode == AuthMode.login ? TextInputAction.done : TextInputAction.next,
